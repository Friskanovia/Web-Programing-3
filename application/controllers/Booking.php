...
{ 
    ...
    { 
        ...
        if ($databooking > 0) { 
            ...
            $this->session->set_flashdata(
                'pesan', 
                '<div class="alert alert-danger alert-message" role="alert">Masih Ada booking buku sebelumnya yang belum diambil.<br> Ambil Buku yang dibooking atau tunggu 1x24 Jam untuk bisa booking kembali </div>');
    ...
    { 
        $id_user = $this->session->userdata('id_user'); 
        $data['upublicser'] = $this->session->userdata('nama'); 
